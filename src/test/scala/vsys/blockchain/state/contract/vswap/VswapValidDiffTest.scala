...
class VswapValidDiffTest extends PropSpec
  with PropertyChecks
  ...
  val preconditionsAndVSwapAddLiquidity: Gen[(GenesisTransaction, GenesisTransaction, RegisterContractTransaction,
    ...
    // add liquidity
    addLiquidityAmountADesired = 1000L
    addLiquidityAmountBDesired = 1000L
  ...
  val preconditionsAndVSwapRemoveLiquidity: Gen[(GenesisTransaction, GenesisTransaction, RegisterContractTransaction,
    ...
    // remove liquidity
    removeLiquidityDesired = 1000L
    removeLiquidityAmountADesired = 1000L
    removeLiquidityAmountBDesired = 1000L
    ...
    depositB, depositLiquidity, setSwap, addLiquidity, removeLiquidity, fee, ts)
