...
trait TokenContractGen {
  ...
  def transferTokenGen(signer: PrivateKeyAccount, contractId: ContractAccount, split: Boolean, data: Seq[Array[Byte]], dataType: Seq[DataType.DataTypeVal],
                       attachment: Array[Byte], fee: Long, ts: Long): Gen[ExecuteContractFunctionTransaction] = {
  ...
  def depositTokenGen(signer: PrivateKeyAccount, contractId: ContractAccount, split: Boolean, data: Seq[Array[Byte]], dataType: Seq[DataType.DataTypeVal],
                       attachment: Array[Byte], fee: Long, ts: Long): Gen[ExecuteContractFunctionTransaction] = {
  ...
  def withdrawTokenGen(signer: PrivateKeyAccount, contractId: ContractAccount, split: Boolean, data: Seq[Array[Byte]], dataType: Seq[DataType.DataTypeVal],
                      attachment: Array[Byte], fee: Long, ts: Long): Gen[ExecuteContractFunctionTransaction] = {
