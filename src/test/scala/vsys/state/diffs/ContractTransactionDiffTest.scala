...
//  val preconditionsAndChangeContract: Gen[(GenesisTransaction, GenesisTransaction, RegisterContractTransaction, ChangeContractStatusTransaction,
...
//    create: RegisterContractTransaction = RegisterContractTransaction.create(master, contract, fee, feeScale, ts + 1).right.get
