...
import vsys.api.http.contract.{ChangeContractStatusRequest, CreateContractRequest, SignedChangeContractStatusRequest, SignedCreateContractRequest}
...
class ContractRequestsTests extends FunSuite with Matchers {
      ...
      """
        {
          ...
          "feeScale": 100,
          "name": "test",
          "content": "vsys test content"
        }
      """

    val req = Json.parse(json).validate[CreateContractRequest].get

    req shouldBe contract.CreateContractRequest("3MwKzMxUKaDaS4CXM8KNowCJJUnTSHDFGMb", "test", "vsys test content", 20000000L, 100)
  }
  ...
  test("SignedCreateContractRequest") {
    ...
    req shouldBe contract.SignedCreateContractRequest("CRxqEuxhdZBEHX42MU4FfyJxuHmbDBTaHMhM3Uki7pLw", 20000000L,
      100, "test", "vsys test content", 0L, "4VPg4piLZGQz3vBqCPbjTfAR4cDErMi57rDvyith5XrQJDLryU2w2JsL3p4ejEqTPpctZ5YekpQwZPTtYiGo5yPC")
  }
