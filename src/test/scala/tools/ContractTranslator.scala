    ...
    x match {
      ...
      case opcType: Byte if opcType == OpcType.CDBVROpc.id =>
        y match {
          ...
          case opcType: Byte if opcType == CDBVRType.MapGetOrDefaultCDBVR.id => nameList(data(4)) + " = operation.db.mapGetOrDefault(db." + stateMapList(data(2)) + ", " + stateNameList(data(3)) + ")"
          case opcType: Byte if opcType == CDBVRType.MapGetCDVVR.id => nameList(data(4)) + " = operation.db.mapGet(db." + stateMapList(data(2)) + ", " + stateNameList(data(3)) + ")"
