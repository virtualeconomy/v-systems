...
object TxConfirmedEventSettings {
	...
	def apply(relatedAcc: Seq[String], afterHeight: Long, afterTime: Long,
			  includeTypes: Seq[Int], excludeTypes: Seq[Int], amtGTE: Long, 
			  amtGT: Long, amtLTE: Long, amtLT: Long, withFee: Boolean): TxConfirmedEventSettings = {

		new TxConfirmedEventSettings(relatedAcc, afterHeight, afterTime, includeTypes, 
									 excludeTypes, amtGTE, amtGT, amtLTE, amtLT, withFee)
	}
}
...
object BlockRollbackEventSettings {
	...
	def apply(relatedAcc: Seq[String], afterHeight: Long, afterTime: Long,
		      withTxsOfTypes: Seq[Int], withTxsOfAccs: Seq[String], withStateOfAccs: Seq[String]): BlockRollbackEventSettings = {
