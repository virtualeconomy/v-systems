...
case class AssetsBroadcastApiRoute(
  ...
  @ApiImplicitParams(Array(
    new ApiImplicitParam(
      ...
      required = true,
      paramType = "body",
      dataType = "vsys.api.http.assets.SignedIssueRequest")))
  @ApiResponses(Array(
  ...
  @ApiImplicitParams(Array(
    new ApiImplicitParam(
      ...
      required = true,
      paramType = "body",
      dataType = "vsys.api.http.assets.SignedReissueRequest")))
  @ApiResponses(Array(
  ...
  @ApiImplicitParams(Array(
    new ApiImplicitParam(
      ...
      required = true,
      paramType = "body",
      dataType = "vsys.api.http.assets.SignedBurnRequest")))
  @ApiResponses(Array(
  ...
  @ApiImplicitParams(Array(
    new ApiImplicitParam(
      ...
      required = true,
      paramType = "body",
      dataType = "vsys.api.http.assets.SignedTransferRequest",
      allowMultiple = true,
  ...
  @ApiImplicitParams(Array(
    new ApiImplicitParam(
      ...
      required = true,
      paramType = "body",
      dataType = "vsys.api.http.assets.SignedExchangeRequest")))
  @ApiResponses(Array(
